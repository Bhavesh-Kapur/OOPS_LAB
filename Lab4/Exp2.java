...
class Exp2
{
    ...
    {
        //player p=new player();
        cricket_player cp=new cricket_player("Bhavesh",19);    //first class object creation and passing of values
        cp.display();

        football_player fp=new football_player("Bhavesh2",19);  //second class object creation and passing of values
        fp.display();

        hockey_player hp=new hockey_player("Bhavesh3",19);       // third class object creation and passing the values
